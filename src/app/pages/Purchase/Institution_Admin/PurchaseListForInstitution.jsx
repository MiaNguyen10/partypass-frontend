...
import { selectPurchaseListForInstitution } from "../../../../core/reducers/purchase/purchaseSlice";
import { getTickets } from "../../../../core/reducers/ticket/ticketSlice";
import { getUsers } from "../../../../core/reducers/user/userSlice";
import { getPurchaseListForInstitution } from "../../../../core/thunk/purchase";
...
const PurchaseListForInstitution = () => {
  ...
  const purchaseListData = useMemo(() => {
    return purchaseList.map((purchaseData) => {
      ...
      actionSubmenu.push({
        ...
        link: purchase_id
          ? () => {
              navigate(`${pages.purchasePathForInstitution}/${purchase_id}`);
            }
          : null,
      });
...
export default PurchaseListForInstitution;
