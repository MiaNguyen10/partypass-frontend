      ...
      <div className="grid gap-4 py-3">
        ...
        <div className="flex flex-wrap">
          ...
          {institution.map_location ? (
            <MapComponent
              mapUrl={institution.map_location}
            />
          ) : (
        ...
        <div>
          ...
          <div className="px-2">
          <img src={institution.cover_photo} alt="cover_photo" width={300} height="auto" />
          </div>
        </div>
        <div className="flex flex-wrap">
          ...
          <div className="px-2 flex flex-col">
            {institution.video_link ? (
              <Link href={institution.video_link} underline="hover" target="_blank" rel="noopener noreferrer">
                <p className="text-cyan-600 italic font-bold">Press here to open video</p>
              </Link>
            ) : (
              <p>No video</p>
            )}
